...
void tolua_ext_imcolor_value_to_luaval(lua_State* L, const ImColor& v, const char*)
{
	if (NULL == L)
		return;
	lua_newtable(L);                                    /* L: table */
	lua_pushstring(L, "r");                             /* L: table key */
	lua_pushnumber(L, (lua_Number)v.Value.x);          /* L: table key value*/
	lua_rawset(L, -3);                                  /* table[key] = value, L: table */
	lua_pushstring(L, "g");                             /* L: table key */
	lua_pushnumber(L, (lua_Number)v.Value.y);          /* L: table key value*/
	lua_rawset(L, -3);                                  /* table[key] = value, L: table */
	lua_pushstring(L, "b");							/* L: table key */
	lua_pushnumber(L, (lua_Number)v.Value.z);        /* L: table key value*/
	lua_rawset(L, -3);                                  /* table[key] = value, L: table */
	lua_pushstring(L, "a");						/* L: table key */
	lua_pushnumber(L, (lua_Number)v.Value.w);       /* L: table key value*/
	lua_rawset(L, -3);                                  /* table[key] = value, L: table */
}
...
void tolua_ext_imvec4_value_to_luaval(lua_State* L, const ImVec4& v, const char*)
{
	...
	lua_pushnumber(L, (lua_Number)v.w);					/* L: table key value*/
	lua_rawset(L, -3);                                  /* table[key] = value, L: table */
}
...
ImColor			tolua_ext_luaval_to_imcolor_value(lua_State* L, int lo, int)
{
	ImColor outValue;
