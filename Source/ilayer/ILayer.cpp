...
//
//	auto e = ax::EventListenerMouse::create();
//	e->onMouseDown = [this](ax::EventMouse* ev)
//	{
//		//CCLOG("x = %f,y = %f", ev->getLocation().x, ev->getLocation().y);
//		const auto b = (int)ev->getMouseButton();
//		if (0 <= b && b < 5)
//			g_MouseJustPressed[b] = true;
//	};
//	e->onMouseUp = [this](ax::EventMouse* ev)
//	{
//		const auto b = (int)ev->getMouseButton();
//		if (0 <= b && b < 5)
//			g_MouseJustPressed[b] = false;
//	};
//	e->onMouseMove = [this](ax::EventMouse* ev)
//	{
//		g_CursorPos.x = ev->getLocation().x * m_glView->getScaleX();
//		g_CursorPos.y = ev->getLocation().y * m_glView->getScaleY();
//	};
//	e->onMouseScroll = [this](ax::EventMouse* ev)
//	{
//		auto old = ImGui::GetCurrentContext();
//		ImGui::SetCurrentContext(m_context);
//
...
//		ImGui::SetCurrentContext(old);
//	};
//	ax::Director::getInstance()->getEventDispatcher()->addEventListenerWithSceneGraphPriority(e, this);
//	auto e2 = ax::EventListenerKeyboard::create();
...
//		ImGui::SetCurrentContext(old);
//	};
//	ax::Director::getInstance()->getEventDispatcher()->addEventListenerWithSceneGraphPriority(e2, this);
//
...
//}
//
//void ILayer::visit(ax::Renderer *renderer, const ax::Mat4 &parentTransform, uint32_t parentFlags)
//{
...
//
//	// Setup time step
//	io.DeltaTime = MAX(ax::Director::getInstance()->getDeltaTime(), imgui_min_delta_time);
//
...
//}
//
//int ILayer::getKey(ax::EventKeyboard::KeyCode code)
//{
