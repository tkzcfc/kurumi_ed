/*
** Lua binding: main
** Generated automatically by tolua++-1.0.92 on Tue Apr  2 16:09:10 2024.
*/
...
#ifndef TOLUA_DISABLE_tolua_main_ImGui_DragFloat300
static int tolua_main_ImGui_DragFloat300(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   bool tolua_ret = (bool)  ImGui::DragFloat3(label,v,v_speed,v_min,v_max,format,power);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
  {
   int i;
...
#if COCOS2D_DEBUG >= 1
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'DragFloat3'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_DISABLE_tolua_main_ImGui_DragFloat400
static int tolua_main_ImGui_DragFloat400(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   bool tolua_ret = (bool)  ImGui::DragFloat4(label,v,v_speed,v_min,v_max,format,power);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
  {
   int i;
...
#if COCOS2D_DEBUG >= 1
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'DragFloat4'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_main_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"ImGui");
   ...
   tolua_function(tolua_S,"DragFloat3",tolua_main_ImGui_DragFloat300);
   tolua_function(tolua_S,"DragFloat4",tolua_main_ImGui_DragFloat400);
