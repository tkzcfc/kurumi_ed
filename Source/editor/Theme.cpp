...
void Theme::styleCommon1()
{
	...
	style.FramePadding = ImVec2(3.5f, 3.5f);
	style.ButtonTextAlign = ImVec2(0.0f, 0.5f);
}

void Theme::styleBlue()
{
	styleCommon1();
	...
	// // colors[ImGuiCol_ComboBg] = colors[ImGuiCol_PopupBg];
...
void Theme::styleRed()
{
	...
	colors[ImGuiCol_SliderGrab] = ImVec4(0.88f, 0.26f, 0.24f, 1.00f);
...
void Theme::styleBrown()
{
	styleCommon1();

	ImVec4* colors = ImGui::GetStyle().Colors;
	colors[ImGuiCol_FrameBg] = ImVec4(0.48f, 0.23f, 0.16f, 0.54f);
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.98f, 0.43f, 0.26f, 0.40f);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.98f, 0.43f, 0.26f, 0.67f);
	colors[ImGuiCol_TitleBg] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.48f, 0.23f, 0.16f, 1.00f);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
	colors[ImGuiCol_CheckMark] = ImVec4(0.98f, 0.43f, 0.26f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.88f, 0.39f, 0.24f, 1.00f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.98f, 0.43f, 0.26f, 1.00f);
	colors[ImGuiCol_Button] = ImVec4(0.98f, 0.43f, 0.26f, 0.40f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.98f, 0.43f, 0.26f, 1.00f);
	colors[ImGuiCol_ButtonActive] = ImVec4(0.98f, 0.28f, 0.06f, 1.00f);
	colors[ImGuiCol_Header] = ImVec4(0.98f, 0.43f, 0.26f, 0.31f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.98f, 0.43f, 0.26f, 0.80f);
	colors[ImGuiCol_HeaderActive] = ImVec4(0.98f, 0.43f, 0.26f, 1.00f);
	colors[ImGuiCol_Separator] = colors[ImGuiCol_Border];
	colors[ImGuiCol_SeparatorHovered] = ImVec4(0.75f, 0.25f, 0.10f, 0.78f);
	colors[ImGuiCol_SeparatorActive] = ImVec4(0.75f, 0.25f, 0.10f, 1.00f);
	colors[ImGuiCol_ResizeGrip] = ImVec4(0.98f, 0.43f, 0.26f, 0.25f);
	colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.98f, 0.43f, 0.26f, 0.67f);
	colors[ImGuiCol_ResizeGripActive] = ImVec4(0.98f, 0.43f, 0.26f, 0.95f);
	colors[ImGuiCol_PlotLines] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
	colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.50f, 0.35f, 1.00f);
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.98f, 0.43f, 0.26f, 0.35f);
	colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
	colors[ImGuiCol_TextDisabled] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
	colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.06f, 0.06f, 0.94f);
	colors[ImGuiCol_ChildWindowBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.00f);
...
void Theme::styleAqua()
{
	...
	colors[ImGuiCol_ResizeGrip] = ImVec4(0.26f, 0.98f, 0.85f, 0.25f);
	...
	colors[ImGuiCol_PlotLines] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
	colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.81f, 0.35f, 1.00f);
...
void Theme::stylePurple()
{
	styleCommon1();

	ImVec4* colors = ImGui::GetStyle().Colors;
	colors[ImGuiCol_WindowBg] = ImVec4(0.14f, 0.12f, 0.16f, 1.00f);
	colors[ImGuiCol_ChildWindowBg] = ImVec4(0.30f, 0.20f, 0.39f, 0.00f);
	colors[ImGuiCol_PopupBg] = ImVec4(0.05f, 0.05f, 0.10f, 0.90f);
	colors[ImGuiCol_Border] = ImVec4(0.89f, 0.85f, 0.92f, 0.30f);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg] = ImVec4(0.30f, 0.20f, 0.39f, 1.00f);
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.41f, 0.19f, 0.63f, 0.68f);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	colors[ImGuiCol_TitleBg] = ImVec4(0.41f, 0.19f, 0.63f, 0.45f);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.41f, 0.19f, 0.63f, 0.35f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.41f, 0.19f, 0.63f, 0.78f);
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.30f, 0.20f, 0.39f, 0.57f);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(0.30f, 0.20f, 0.39f, 1.00f);
	colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.41f, 0.19f, 0.63f, 0.31f);
	colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.41f, 0.19f, 0.63f, 0.78f);
	colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	// colors[ImGuiCol_ComboBg] = ImVec4(0.30f, 0.20f, 0.39f, 1.00f);
	colors[ImGuiCol_CheckMark] = ImVec4(0.56f, 0.61f, 1.00f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.41f, 0.19f, 0.63f, 0.24f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	colors[ImGuiCol_Button] = ImVec4(0.41f, 0.19f, 0.63f, 0.44f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.41f, 0.19f, 0.63f, 0.86f);
	colors[ImGuiCol_ButtonActive] = ImVec4(0.64f, 0.33f, 0.94f, 1.00f);
	colors[ImGuiCol_Header] = ImVec4(0.41f, 0.19f, 0.63f, 0.76f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.41f, 0.19f, 0.63f, 0.86f);
	colors[ImGuiCol_HeaderActive] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	colors[ImGuiCol_ResizeGrip] = ImVec4(0.41f, 0.19f, 0.63f, 0.20f);
	colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.41f, 0.19f, 0.63f, 0.78f);
	colors[ImGuiCol_ResizeGripActive] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	// colors[ImGuiCol_CloseButton] = ImVec4(1.00f, 1.00f, 1.00f, 0.75f);
	// colors[ImGuiCol_CloseButtonHovered] = ImVec4(0.88f, 0.74f, 1.00f, 0.59f);
	// colors[ImGuiCol_CloseButtonActive] = ImVec4(0.88f, 0.85f, 0.92f, 1.00f);
	colors[ImGuiCol_PlotLines] = ImVec4(0.89f, 0.85f, 0.92f, 0.63f);
	colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	colors[ImGuiCol_PlotHistogram] = ImVec4(0.89f, 0.85f, 0.92f, 0.63f);
	colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.41f, 0.19f, 0.63f, 1.00f);
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.41f, 0.19f, 0.63f, 0.43f);
	colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);

	resetChildBg();
}

void Theme::styleBlackOrange()
{
	styleCommon1();
